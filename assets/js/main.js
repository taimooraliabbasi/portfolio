...
/**
  ...
  */
(function () {
	var waNumber = '971526310024';
	var pageTitle = (document.title || 'Portfolio').trim();
	var customMessage = 'Hi Ali, I came across your "' + pageTitle + '" page and wanted to connect with you. Looking forward to your reply.';
	var waUrl = 'https://wa.me/' + waNumber + '?text=' + encodeURIComponent(customMessage);

	var widget = document.createElement('div');
	widget.className = 'wa-widget';
	widget.innerHTML = '<a class="wa-widget__link" href="' + waUrl + '" target="_blank" rel="noopener noreferrer" aria-label="Chat with Ali on WhatsApp">' + '<i class="wa-widget__icon fa fa-whatsapp" aria-hidden="true"></i>' + '<span class="wa-widget__text">Chat on WhatsApp</span>' + '</a>';
